...
const messages = {
  'zh-CN': {
    ...
    onboardingDescription:
      '此应用（扩展）可用于扫描和生成二维码，所有处理均在本地完成，不发起任何网络请求。',
    useCasesTitle: '主要用途',
  ...
  en: {
    ...
    onboardingDescription:
      'This app(extension) scans and generates QR codes, and all processing stays local with no network requests.',
