...
const messages = {
  "zh-CN": {
    ...
    confirmButton: "开始使用",
    installApp: "安装 App",
    installBannerNative: "可添加到桌面，像 App 一样独立运行。",
    installBannerIos: "可通过分享菜单添加到主屏幕，像 App 一样打开。",
    dismissInstallHint: "关闭安装提示",
    installDialogTitle: "添加到主屏幕",
    installDialogDescription: "添加后可从桌面直接打开，并以独立窗口运行。",
    installDialogStep1: "点击浏览器的分享按钮。",
    installDialogStep2: "选择“添加到主屏幕”。",
    installDialogStep3: "确认名称后点击“添加”。",
    installDialogAction: "我知道了",
    generateTab: "生成",
    scanTab: "扫描",
    ...
    copyText: "复制",
    copiedText: "已复制",
    pasteGenerateInput: "从剪贴板粘贴",
    pasteGenerateUnsupported: "当前浏览器不支持读取文本剪贴板。",
    pasteGenerateEmpty: "剪贴板中没有可填充的文本。",
    pasteGenerateFailed: "读取剪贴板失败，请检查浏览器权限后重试。",
    openLink: "打开链接",
  ...
  en: {
    ...
    installBannerNative: "Add it to your home screen and open it like an app.",
    installBannerIos: "Use the Share menu to add it to your home screen.",
    dismissInstallHint: "Dismiss install hint",
    installDialogTitle: "Add to Home Screen",
    installDialogDescription:
      "Once added, you can launch it from your home screen in a standalone window.",
    installDialogStep1: "Tap the browser Share button.",
    installDialogStep2: "Choose “Add to Home Screen”.",
    installDialogStep3: "Confirm the name and tap “Add”.",
    installDialogAction: "Got it",
    ...
    generateTooLarge: "The input is too long to fit in a QR code. Shorten the text and try again.",
    ...
    dismissScanResult: "Dismiss scan result",
    ...
    copyText: "Copy",
    copiedText: "Copied",
    pasteGenerateInput: "Paste from clipboard",
    pasteGenerateUnsupported: "This browser does not support reading text from the clipboard.",
    pasteGenerateEmpty: "There is no text to paste from the clipboard.",
    pasteGenerateFailed: "Failed to read the clipboard. Check browser permissions and try again.",
    openLink: "Open Link",
